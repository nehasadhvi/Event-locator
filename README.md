# Event-locator
<ul>
<li>Locate events in your city by filtering using name and category</li>
<li>Data is obtained by consuming EventBright REST API</li>
</ul>
...
```
git clone git@github.com:nehasadhvi/Event-locator.git
```
or
```
git clone https://github.com/nehasadhvi/Event-locator.git
```
